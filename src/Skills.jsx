  ...
  return (
    <div id="Skills" className="p-20 flex flex-col items-center justify-center">
      ...
      <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 justify-around gap-10 ">
        ...
        >
          <FaHtml5 className=" text-[100px] flex items-center justify-center font-semibold text-tertiary hover:text-orange-600 rounded-ss-3xl rounded-br-3xl b_glow p-2" />
        </a>
        <a
          data-aos="fade-down"
          ...
          rel="noopener noreferrer"
        >
          <FaCss3Alt className=" text-[100px] flex items-center text-tertiary hover:text-blue-800 rounded-ss-3xl rounded-br-3xl b_glow p-2" />
        </a>
        <a
          data-aos="fade-up"
          ...
          rel="noopener noreferrer"
        >
          <AiOutlineJavaScript className=" text-[100px] flex items-center text-tertiary hover:text-yellow-400 rounded-ss-3xl rounded-br-3xl b_glow p-2" />
        </a>
        <a
          data-aos="fade-up"
          ...
          rel="noopener noreferrer"
        >
          <SiTypescript className=" text-[100px] flex items-center text-tertiary hover:text-blue-600 rounded-ss-3xl rounded-br-3xl b_glow p-2" />
        </a>
        {/* ...... ANGULAR........<a
          data-aos="fade-up"
        ...
        <a
          ...
          rel="noopener noreferrer"
        >
          <FaReact className=" text-[100px] flex items-center text-tertiary hover:text-indigo-800 rounded-ss-3xl rounded-br-3xl b_glow p-2" />
        </a>
        {/* ......NODE JS........<a
          data-aos="fade-up"
